...
<div id="carouselExampleDark" class="carousel carousel-dark slide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="1000">
            <img src="{{ asset('imgs/img_banner.png') }}" style="height: 400px; width: 100%" alt="...">
        ...
        <div class="carousel-item" data-bs-interval="2000">
            <img src="{{ asset('imgs/img_banner3.png') }}" style="height: 400px; width: 100%" alt="...">
            <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item" data-bs-interval="1000">
            <img src="{{ asset('imgs/img_banner4.png') }}" style="height: 400px; width: 100%" alt="...">
            <div class="carousel-caption d-none d-md-block">
    ...
    <button class="carousel-control-prev d-none d-xl-block" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next d-none d-xl-block" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
