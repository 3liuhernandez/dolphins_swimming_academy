            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4">
                    ...
                    <div class="map_icon">
                        ...
                        <span class="paddlin_left_0">London 145 United Kingdom</span>
                    </div>
                    <div class="map_icon_1">
                        <img src="{{asset('template/images/call-icon.png')}}">
                        <span class="paddlin_left_0">+7586656566<br>+9876543210</span>
                    </div>
                    <div class="map_icon">
                ...
                <div class="row m-0 my-5">
                    <p class="m-0 text-white text-center small">
                        © <?php echo date('Y'); ?> Dolphins Swimming. Todos los derechos reservados.
                    </p>
                </div>
            </div>
        </div>
