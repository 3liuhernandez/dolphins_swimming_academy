            ...
            <div class="row m-0">
                <div class="col-12 p-0">
                    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators" style="z-index: 37837945;">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('imgs/hijos_clases_natacion.png') }}" class="w-100 h-100" alt="...">
                                {{-- <div class="container">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('imgs/natacion_instructor-_ninos.png') }}" class="w-100 h-100" alt="...">
                                {{-- <div class="container">
                            ...
                            <div class="carousel-item">
                                <img src="{{ asset('imgs/natacion_instructor_ninos2.png') }}" class="w-100 h-100" alt="...">
                                {{-- <div class="container">
        ...
        <div class="container marketing">
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <h2 class="fw-normal">Instructor Nombre</h2>
                    <p>
