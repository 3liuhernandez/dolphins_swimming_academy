                    ...
                    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="{{ asset('imgs/img_banner_carusel_home.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                            </div>
                            <?php for ($i=0; $i < 6; $i++) { ?>
                            @if ($i === 0)
                                <div class="carousel-item">
                                    <img src="{{ asset('imgs/img_banner_carusel_home-2.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                                </div>
                            @elseif($i === 1)
                                <div class="carousel-item">
                                    <img src="{{ asset('imgs/img_banner_carusel_home-3.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                                </div>
                            @elseif($i === 2)
                                <div class="carousel-item">
                                    <img src="{{ asset('imgs/img_banner_carusel_home-4.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                                </div>
                            @elseif($i === 3)
                                <div class="carousel-item">
                                    <img src="{{ asset('imgs/img_banner_carusel_home-5.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                                </div>
                            @elseif($i === 4)
                                <div class="carousel-item">
                                    <img src="{{ asset('imgs/img_banner_carusel_home-6.png') }}" style="width: 100%;height:50vh" alt="..." loading="lazy">
                                </div>
                            @elseif($i)
                            @endif
                            <?php }?>
        ...
        <div class="container">
            ...
            <div class="row m-0 g-5 gx-lg-4">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member shadow">
                        <div class="member-img">
                            <img src="{{ asset('imgs/Photos_instructors/photo3.jpeg') }}" class="img-fluid" alt="" loading="lazy">
                            <div class="social">
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member shadow">
                        <div class="member-img">
                            <img src="{{ asset('imgs/Photos_instructors/photo2.jpeg') }}" class="img-fluid" alt="" loading="lazy">
                            <div class="social">
                                <a href="#"><i class="bi bi-twitter"></i></a>
                                <a href="#"><i class="bi bi-facebook"></i></a>
                                <a href="#"><i class="bi bi-instagram"></i></a>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member shadow">
                        <div class="member-img">
                            <img src="{{ asset('imgs/Photos_instructors/photo1.jpeg') }}" class="img-fluid" alt="" loading="lazy">
                            <div class="social">
                                <a href="#"><i class="bi bi-twitter"></i></a>
                                <a href="#"><i class="bi bi-facebook"></i></a>
                                <a href="#"><i class="bi bi-instagram"></i></a>
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member shadow">
                        <div class="member-img">
                            <img src="{{ asset('imgs/Photos_instructors/photo4.jpeg') }}" class="img-fluid" alt="" loading="lazy">
                            <div class="social">
                                <a href="#"><i class="bi bi-twitter"></i></a>
                                <a href="#"><i class="bi bi-facebook"></i></a>
                                <a href="#"><i class="bi bi-instagram"></i></a>
