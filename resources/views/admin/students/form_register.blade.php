            ...
            <div class="row m-0 mb-3">
                <div class="col-md-6 form-group">
                    <input
                        ...
                        name="dni"
                        type="text"
                        class="form-control field @error('dni') is-invalid @enderror"
                ...
                <div class="col-md-3 form-group mt-2 mt-md-0">
                    <input
                        ...
                        name="age"
                        type="number"
                        class="form-control field @error('age') is-invalid @enderror"
                        placeholder="Edad"
                        required
                        autofocus
                        value="{{old('age')}}"
            ...
            <div class="row m-0 mb-3">
                <div class="col-md-6 form-group">
                    <input
                        ...
                        name="phone"
                        type="text"
                        class="form-control field @error('phone') is-invalid @enderror"
                        placeholder="Tlf de contacto"
                        required
                        autofocus
                        value="{{old('phone')}}"
                    >
