                    ...
                    <form action="{{ route('admin.login.validate') }}" method="POST">
                        ...
                        <div class="p-2 p-lg-4">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg_color-blue-main"><i class="bi bi-person-plus-fill text-white"></i></span>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg_color-blue-main"><i class="bi bi-key-fill text-white"></i></span>
                                <input type="password" class="form-control" placeholder="password" name="pass" required value="{{ old('pass') }}">
                            </div>

                            <button class="btn w-100 mt-2 text-white fw-semibold bg_color-blue-main"type="submit">Iniciar Sesión</button>
                        </div>
                    </form>
                </div>
            </div>
