...
@section('body')
            ...
            <div class="row m-0">
                <div class="col-12">
                    <div class="text-welcome py-3 my-0 my-sm-3 my-md-4 my-lg-5 text-center d-flex flex-column justify-content-around align-items-center">
                        <h1 class="display-2 fw-normal m-0">¡Bienvenidos nuevos estudiantes!</h1>
                        <p class="text-muted fw-normal my-4 my-lg-3">
                ...
                <?php for($i=0; $i < 3 ; $i++) { ?>
                    <div class="col-6">
                        <div class="d-flex flex-wrap justify-content-center">
                            ...
                            @endif
                            <div class="text-center border rounded p-3 mt-3 mt-lg-0">
    ...
    <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
        <path
    ...
    <section id="features">
        <div class="container">
            <div class="row m-0">
                ...
                <ul class="nav nav-tabs row d-flex border-0 m-0 justify-content-between align-items-center" role="tablist">
                    ...
                    <li class="nav-item col-2">
                        <a class="nav-link show px-lg-2" onmousedown="sonido.play()" data-bs-toggle="tab" href="#tab-2" aria-selected="false" role="tab" tabindex="-1">
                            ...
                            <h4 class="d-none d-lg-block">Nivel</h4>
                        </a>
                    </li>
                    ...
                    <li class="nav-item col-2">
                        <a class="nav-link px-lg-2" onmousedown="sonido.play()" data-bs-toggle="tab" href="#tab-5" aria-selected="false" role="tab" tabindex="-1">
                            ...
                            <h4 class="d-none d-lg-block">Avanzado</h4>
                        </a>
                    </li>
                </ul>
