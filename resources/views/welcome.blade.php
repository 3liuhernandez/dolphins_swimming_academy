...
@section('body')
            ...
            <div class="row mb-5 mx-0">
                <div class="col-12">
                    <div class="text-welcome my-5 py-5 text-center d-flex flex-column justify-content-around align-items-center">
                        <h1 class="display-3 fw-semibold text_color-blue-main w-75 lh-1 m-0" style="text-shadow: 1px 1px 2px #7c7c7c;">¡Bienvenidos nuevos estudiantes!</h1>
                        <p class="fw-semibold my-4 text_color-blue-derivate">
                            Regístrese ahora para recibir una lección de prueba de 25 minutos, ¡completamente gratis!
                        </p>
                        <button type="button" class="btn btn-md bg_color-blue-derivate text-white" href="#">Haga click para registrarse</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="galery_card">
        <div class="container p-sm-3 py-lg-0 my-5">
            ...
            <div class="row m-0 g-4 py-2 py-md-3 p-lg-0 row-cols-1 row-cols-sm-2 row-cols-md-3 flex-wrap justify-content-center">
                <?php for($i = 0; $i < 6; $i++) { ?>
                <div class="col m-0 p-0 p-sm-2 p-md-2 p-lg-3">
                    <div class="card shadow border-0">
                        <a class="nav-link" href="#"><img src="{{ asset('imgs/img_banner.png') }}" class="img-fluid p-3" alt="..."></a>
                        <div class="card-body">
            ...
            <div class="row m-0">
                <div class="col-12 p-0 mt-0 my-lg-5 mt-lg-0">
                    <div class="my-5 py-5 text-center d-flex flex-column justify-content-center align-items-center">
                        <h2 class="display-3 m-0 fw-semibold text_color-blue-main" style="text-shadow: 1px 1px 2px #7c7c7c;">Natacion Profesional</h2>
    ...
    <section id="api-youtube">
        <div class="container">
            <div class="row my-5 py-5 mx-0">
                ...
                <div class="row p-0 my-5 mx-0 box-iframe d-flex justify-content-center">
            ...
            <div class="row mx-0 my-5 py-5">
                <div class="col-12 text-center p-0">
                    <div class="information_horarios">
                        <h2 class="display-3 fw-semibold text_color-blue-main" style="text-shadow: 1px 1px 2px #7c7c7c;">Horarios de apertura</h2>
                        <p class="fw-semibold text_color-blue-derivate pb-3 m-0 w-75 mx-auto">
    ...
    <section id="contact">
        <div class="container bg-light border-top border-bottom rounded my-5 py-4">
            <h2 class="fw-semibold text-center mb-3 text_color-blue-derivate">Contactame !</h2>
            <p class="text-center my-5 mx-3 mb-lg-0">
            ...
            <div class="row m-0">
                ...
                <div class="col-12 col-lg-4 py-4 d-flex justify-content-center">
