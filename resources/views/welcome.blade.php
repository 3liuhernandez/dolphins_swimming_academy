                ...
                <div class="col-12">
                    <div class="text-welcome py-3 my-0 my-sm-3 my-md-4 my-lg-5 text-center d-flex flex-column justify-content-around align-items-center">
                        ...
                        <p class="fw-semibold text-muted my-4 my-lg-3">
                            Concebimos al ejercicio como un apoyo para lograr alcanzar un estado de salud física y emocional, 
                            dado no solo por la ausencia de enfermedad, sino también por la posibilidad de disfrutar de las diferentes 
    ...
    <section id="stadistic_section">
        <div class="container px-5 py-2 py-lg-5" id="icon-grid">
            <div class="row row-cols-md-3 row-cols-lg-4 m-0 gx-4 gy-3 flex-wrap justify-content-center">
                <?php for($i=0; $i < 3 ; $i++) { ?>
                    <div class="col">
                        <div class="d-flex flex-wrap justify-content-center p-3">
                            @if($i === 0)
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-bootstrap-reboot" viewBox="0 0 16 16">
                ...
                <?php }?>
                <div class="col col-sm-6 col-md-12 col-lg-3 mx-auto">
    ...
    <section id="galeria_section">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
            <path d="M0,0v25.8c4.2,1.1,8.1,4.1,11,9.1c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0
                ...
                c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0
                c1.9,3.2,4.3,5.5,7,6.8V0H0z"></path>
            <path d="M993,40.9c-7.4-12.8-21.9-12.8-29.3,0c-6.3,10.8-19,10.8-25.3,0c-7.4-12.8-21.9-12.8-29.3,0c-6.3,10.8-19,10.8-25.3,0
                ...
                c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0
                c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0
                c6.3,10.8,19,10.8,25.3,0c7.4-12.8,21.9-12.8,29.3,0c1.9,3.2,4.3,5.5,7,6.8v-6.2C997.3,46.4,994.9,44.1,993,40.9z"></path>
            ...
            <div class="tab-content">
                <div class="tab-pane active show" id="tab-1" role="tabpanel">
                    ...
                    <div class="tab-pane" id="tab-3" role="tabpanel">
                        <div class="row m-0">
                            <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                            <h3 class="my-3">Con los placeres del placer los acusamos de repudiarlos, pero de sufrir para ser aceptados</h3>
                            <p class="lh-1">
            ...
            <div class="col-lg-8 mt-5 mt-lg-0">
                <form action="#" method="post" class="php-email-form">
                    ...
                    <div class="form-group mt-2">
                        <input type="text" class="form-control" name="subject" id="subject" placeholder="sujeto" required></div>
                        <div class="form-group mt-2">
