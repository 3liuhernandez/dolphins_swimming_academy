                ...
                <div id="myCarousel" class="carousel slide m-0" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('imgs/img_banner.png') }}" class="w-100 h-100" alt="...">
                            <div class="container">
                        ...
                        <div class="carousel-item">
                            <img src="{{ asset('imgs/img_banner3.png') }}" class="w-100 h-100" alt="...">
                            <div class="container">
                        ...
                        <div class="carousel-item">
                            <img src="{{ asset('imgs/img_banner4.png') }}" class="w-100 h-100" alt="...">
                            <div class="container">
