                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active" id="item-carusel">
                            ...
                            <div class="carousel-caption mb-lg-5">
                                ...
                                <p class="mx-auto w-75">Some representative placeholder content for the second slide of the carousel. </p>
                                <a class="btn bg_color-blue-derivate text-white btn-sm" href="{{ route('class') }}">Learn more</a>
                            </div>
                        </div>
                        <div class="carousel-item" id="item-carusel">
                            ...
                            <div class="carousel-caption text-start mb-lg-5">
                                ...
                                <p class="w-75">Some representative placeholder content for the first slide of the carousel.</p>
                                <a class="btn bg_color-blue-derivate text-white btn-sm" href="{{ route('register') }}">Regístrate hoy</a>
                            </div>
                        </div>
                        <div class="carousel-item" id="item-carusel">
                            <img src="{{ asset('imgs/img_banner_carusel_home-3.png') }}" alt="...">
                            <div class="carousel-caption text-end mb-lg-5 d-flex flex-column align-items-end">
                                <h2>One more for good measure.</h2>
                                <p class="w-75">Some representative placeholder content for the third slide of this carousel.</p>
                                <a class="btn bg_color-blue-derivate text-white btn-sm" href="#galery_card">Ver galeria</a>
                            </div>
                        </div>
                        <div class="carousel-item" id="item-carusel">
